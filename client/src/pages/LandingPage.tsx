...
const DUMMY_CSV_URL = 'https://github.com/JunBeul/edutech-risk-prediction/raw/refs/heads/main/data/dummy/dummy_midterm_like_labeled.csv';
	...
	return (
		<div className='landing_page'>
			<section className='landing_hero'>
				<h1>최소성취수준 미도달 위험 예측 AI</h1>
				<p>
					학기 중간 시점의 학습/행동 데이터를 바탕으로
					<br />
					최소성취수준 미도달 위험 학생을 조기에 탐지하는 EduTech 프로젝트입니다.
				</p>
			...
			<section className='landing_section'>
				...
				<ul>
					...
					<li>위험 판단 근거(`top_reasons`)와 권장 조치(`action`)를 함께 확인할 수 있습니다.</li>
			...
			<section className='landing_section'>
				...
				<ol>
					...
					<li>
						<strong>결과 확인:</strong> 대시보드에서 위험 학생 목록, 주요 사유, 남은 결석 가능 횟수 등을 확인하고 보고서를 내려받습니다.
					</li>
				</ol>
			</section>
			...
			<section className='landing_section'>
				<h2>권장 입력 기준</h2>
				<p>중간/기말/수행 반영 비율의 합은 반드시 100이어야 하며, 임계값(`threshold`)은 보통 `0.4`부터 시작해 교육청 정책에 맞게 조정하는 것을 권장합니다.</p>
			</section>
